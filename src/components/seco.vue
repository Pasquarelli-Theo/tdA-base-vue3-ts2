...
<template>
  ...
  <div class="flex justify-center bg-red-300">
    <button  class="bg-red-700 hover:text-white m-4 p-6 text-xl font-bold rounded-lg" v-if="user" @pointerdown="supabase.auth.signOut( ) ">
    ...
    <FormKit
      ...
      :submit-attrs="{
        classes: {
          input:
            'bg-white  m-4 p-4 rounded hover:bg-black hover:text-red-300',
        },
      }"
